...
public class MapBoard : MonoBehaviour
{
    ...
    public List<TerrainController> GetTerrain_Colum(int idx2D)
    {
        return GetTerrain_Colum(idx2D, false);
    }
    //! 맵의 x 좌표를 받아서 해당 열의 타일을 리스트로 가져오는 함수 / 오버로딩
    public List<TerrainController> GetTerrain_Colum(int xIdx2D, bool isSortReverse)
    {
    ...
    {
        List<int> idx1D_arount4ways = new List<int>();
        ...
        foreach (var idx2D in idx2D_around4ways)
        {
            ...
            idx1D_arount4ways.Add(GetTileIdx1D(idx2D));
        }

        return idx1D_arount4ways;
